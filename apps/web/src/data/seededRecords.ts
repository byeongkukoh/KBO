...
export const leaderboardCategories: LeaderboardCategory[] = [
  ...
  { key: "woba", label: "wOBA", playerType: "hitter", statKey: "woba", descending: true, precision: 3 },
  { key: "wrc", label: "wRC", playerType: "hitter", statKey: "wrc", descending: true, precision: 1 },
  { key: "wrcPlus", label: "wRC+", playerType: "hitter", statKey: "wrcPlus", descending: true, precision: 1 },
  ...
  { key: "fip", label: "FIP", playerType: "pitcher", statKey: "fip", descending: false, precision: 2 },
];
